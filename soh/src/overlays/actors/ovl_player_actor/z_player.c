...
void Player_SetParallel(Player* this) {
    ...
    if (!(this->skelAnime.movementFlags & ANIM_FLAG_OVERRIDE_MOVEMENT) && (this->actor.bgCheckFlags & BGCHECKFLAG_PLAYER_WALL_INTERACT) &&
...
s32 Player_ActionHandler_5(Player* this, PlayState* play) {
    ...
    if (!(this->stateFlags1 & PLAYER_STATE1_CARRYING_ACTOR) &&
        ...
        if (!func_808332B8(this) &&
            ...
            (sTouchedWallFlags & WALL_FLAG_6) && (this->actor.bgCheckFlags & BGCHECKFLAG_GROUND) && (this->yDistToLedge >= 39.0f)) {
